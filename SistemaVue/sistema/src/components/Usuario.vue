                            ...
                            <v-container grid-list-md>
                                <v-layout wrap>
                                    ...
                                    <v-flex xs12 sm12 md12>
                                        ...
                                        :items="Roles" label="Rol"></v-select>
                                    </v-flex>
                                    <v-flex xs12 sm12 md12>
    ...
    export default {
        ...
        methods:{
            ...
            validar(){
                ...
                if(!this.email){
                    this.validaMensaje.push("Ingrese un mail.")
                }
                if(!this.telefono){
                    this.validaMensaje.push("Ingrese un telefono.")
                }
                if(!this.usuario){
                    this.validaMensaje.push("Ingrese el nombre de usuario.")
                }
                if(!this.password){
